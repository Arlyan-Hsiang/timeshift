...
else
{
	...
	else
	{
		...
		{
		echo "<table border='3' width='600' height='400'   bordercolor='beige'  class='hovertable'>";
	echo "<thead><tr bgcolor='aliceblue'><td></td><td>MON</td><td>TUE</td><td>WED</td><td>THU</td><td>FRI</td><td>SAT</td><td>SUN</td></tr></thead>";
	for($i=0;$i<14;$i++)
	{
		if($i%7==0&&$i!=0)
		{
