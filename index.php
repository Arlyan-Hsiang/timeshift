	...
	<body class="easyui-layout">
		...
		<div data-options="region:'north'" style="height: 50%;background-image: url(img/layout-browser-hd-bg.gif);">
			...
			<span id="n_logo" style="margin-left: 20px;">
				...
				<font color="white" size="4px">Hulucat Administrator</font>
			</span>
			<span id="n_title" style="float: right;">
				
				Welcome  <?php echo $_COOKIE["user"];?>&nbsp;&nbsp;&nbsp;
				<a id="n_title_pwd" href="javascript:void(0)">Change Password</a>  
				<a id="n_title_out" href="javascript:void(0)">Exit</a>
			</span>
		</div>
		<!--布局：南-->
					...
					<ul id="treeMenu" class="easyui-tree">
						<li>
							<?php
							 ...
							 if($admin[0]==0) {
							 	?>
							 <span>Shift Option</span>
							<ul>
								<li data-options="attributes:{url:'add_table.php'}">提交本週可上班日</li>
								<li data-options="attributes:{url:'end_print.php'}">本週班表</li>
							</ul>
						<li>
							<span>Personal Information</span>
							<ul>
								<li data-options="attributes:{url:'information.php'}">Personal Information</li>
							</ul>
						</li>
						<li>
							<span>系统信息</span>
						 ...
						 <?php } 
							...
							<span>Manager Option</span>
							<!--二级-->
							<ul>
								<li data-options="attributes:{url:'addadmin.php'}">Admin Management</li>
								<li data-options="attributes:{url:'manageadmin.php'}">Staff Management</li>
								<li data-options="attributes:{url:'shoud.php'}">Shift Management</li>
								<li data-options="attributes:{url:'show_all.php'}">Staffs Availibility</li>
								<li data-options="attributes:{url:'end_print.php'}">Weekly Shift</li>
							</ul>
						<li>
							<span>Shift Option</span>
							<ul>
