...
<body>
	...
	<table class="easyui-datagrid" title="所有提交的排班" style="width:700px;height:250px"
			 iconCls='icon-table'  rownumbers='true' fitColumns='true' singleSelect='true' toolbar='#toolbar'">
		<thead>
			<tr>
				<th data-options="field:'0'">Staff</th>
				<th data-options="field:'1'">MON1</th>
				<th data-options="field:'2'">MON2</th>
				<th data-options="field:'3'">TUE1</th>
				<th data-options="field:'4'">TUE2</th>
				<th data-options="field:'5'">WED1</th>
				<th data-options="field:'6',align:'center'">WED2</th>
				<th data-options="field:'7'">THU1</th>
				<th data-options="field:'8'">THU2</th>
				<th data-options="field:'9',align:'center'">FRI1</th>
				<th data-options="field:'10'">FRI2</th>
				<th data-options="field:'11'">SAT1</th>
				<th data-options="field:'12'">SAT2</th>
				<th data-options="field:'13'">SUN1</th>
				<th data-options="field:'14'">SUN2</th>
			</tr>
		</thead>
		<tbody>
...
handler:cancelall 
	...
	echo "<table border='1' width='700'class='hovertable'>";
	echo "<thead><tr bgcolor='coral'><td colspan='46' align='center'>管理员'$x'你好，以下为所有人的排班</td></tr></thead>";
	echo "<thead><tr bgcolor='coral'><td></td><td>MON</td><td>TUE</td><td>WED</td><td>THU</td><td>FRI</td><td>SAT</td><td>SUN</td></tr></thead>";
	$temp=0;
	for($i=0;$i<14;$i++)
	{
		if($i%7==0&&$i!=0)
